...
" Normal text without explicit background
call s:HL('NormalNoBg', s:fg1)
...
call s:HL('Search',    s:none, s:bg0, s:inverse)
...
hi! link vimUserFunc NormalNoBg
...
hi! link erlangGlobalFuncCall NormalNoBg
hi! link erlangLocalFuncRef NormalNoBg
