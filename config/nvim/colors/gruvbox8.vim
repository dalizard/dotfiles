...
let s:italics = s:italics && get(g:, 'gruvbox8_italics', 1)
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox8_transp_bg', 0) && !has('gui_running')
      ...
      hi SignColumn guifg=#ebdbb2 guibg=#1d2021 guisp=NONE gui=NONE cterm=NONE
    ...
    hi Folded guifg=#928374 guibg=NONE guisp=NONE gui=italic cterm=italic
    ...
    hi Error guifg=#ad3b14 guibg=#242627 guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, "gruvbox8_plugin_hi_groups", 0)
      hi ALEError guifg=NONE guibg=NONE guisp=#fb4934 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
      hi ALEWarning guifg=NONE guibg=NONE guisp=#fabd2f gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
      hi ALEInfo guifg=NONE guibg=NONE guisp=#83a598 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
      hi ALEErrorSign guifg=#fb4934 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi ALEWarningSign guifg=#fabd2f guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi ALEInfoSign guifg=#83a598 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      ...
      if get(g:, 'indent_guides_auto_colors', 0)
        if get(g: 'gruvbox8_invert_indent_guides', 0)
    ...
    if get(g:, "gruvbox8_filetype_hi_groups", 0)
      ...
      hi jsImport guifg=#d3869b guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi jsExport guifg=#fb4934 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi jsFrom guifg=#d3869b guibg=NONE guisp=NONE gui=NONE cterm=NONE
      ...
      hi jsClassKeyword guifg=#83a598 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi jsClassProperty guifg=#b8bb26 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi jsExtendsKeyword guifg=#83a598 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      ...
      hi jsBlock guifg=#fabd2f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'gruvbox8_transp_bg', 0) && !has('gui_running')
    ...
    hi SignColumn guifg=#3c3836 guibg=#fbf1c7 guisp=NONE gui=NONE cterm=NONE
  ...
  hi Visual guifg=NONE guibg=#d5c4a1 guisp=NONE gui=NONE cterm=NONE
  ...
  hi NormalMode guifg=#7c6f64 guibg=#fbf1c7 guisp=NONE gui=reverse cterm=reverse
  hi InsertMode guifg=#076678 guibg=#fbf1c7 guisp=NONE gui=reverse cterm=reverse
  hi ReplaceMode guifg=#427b58 guibg=#fbf1c7 guisp=NONE gui=reverse cterm=reverse
  hi VisualMode guifg=#af3a03 guibg=#fbf1c7 guisp=NONE gui=reverse cterm=reverse
  hi CommandMode guifg=#8f3f71 guibg=#fbf1c7 guisp=NONE gui=reverse cterm=reverse
  hi Warnings guifg=#af3a03 guibg=#fbf1c7 guisp=NONE gui=reverse cterm=reverse
  if has('nvim')
    hi! link TermCursor Cursor
  ...
  if get(g:, "gruvbox8_plugin_hi_groups", 0)
    ...
    hi ALEWarning guifg=NONE guibg=NONE guisp=#b57614 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
    hi ALEInfo guifg=NONE guibg=NONE guisp=#076678 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
    hi ALEErrorSign guifg=#9d0006 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi ALEWarningSign guifg=#b57614 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi ALEInfoSign guifg=#076678 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, "gruvbox8_filetype_hi_groups", 0)
    ...
    hi jsImport guifg=#8f3f71 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi jsExport guifg=#9d0006 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi jsFrom guifg=#8f3f71 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi jsClassKeyword guifg=#076678 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi jsClassProperty guifg=#79740e guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi jsExtendsKeyword guifg=#076678 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi jsBlock guifg=#b57614 guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Error ctermfg=124 ctermbg=235 cterm=NONE
    ...
    if get(g:, "gruvbox8_filetype_hi_groups", 0)
      ...
      hi jsImport ctermfg=175 ctermbg=NONE cterm=NONE
      hi jsExport ctermfg=203 ctermbg=NONE cterm=NONE
      hi jsFrom ctermfg=175 ctermbg=NONE cterm=NONE
      ...
      hi jsClassKeyword ctermfg=109 ctermbg=NONE cterm=NONE
      hi jsClassProperty ctermfg=142 ctermbg=NONE cterm=NONE
      hi jsExtendsKeyword ctermfg=109 ctermbg=NONE cterm=NONE
      ...
      hi jsBlock ctermfg=214 ctermbg=NONE cterm=NONE
  ...
  if get(g:, "gruvbox8_plugin_hi_groups", 0)
    ...
    hi ALEInfoSign ctermfg=23 ctermbg=NONE cterm=NONE
  ...
  if get(g:, "gruvbox8_filetype_hi_groups", 0)
    ...
    hi jsImport ctermfg=126 ctermbg=NONE cterm=NONE
    hi jsExport ctermfg=124 ctermbg=NONE cterm=NONE
    hi jsFrom ctermfg=126 ctermbg=NONE cterm=NONE
    ...
    hi jsClassKeyword ctermfg=23 ctermbg=NONE cterm=NONE
    hi jsClassProperty ctermfg=100 ctermbg=NONE cterm=NONE
    hi jsExtendsKeyword ctermfg=23 ctermbg=NONE cterm=NONE
    ...
    hi jsBlock ctermfg=172 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi Error ctermfg=Red ctermbg=DarkGray cterm=NONE
...
" Color: fg5             rgb(173, 59, 20)      124 Red
