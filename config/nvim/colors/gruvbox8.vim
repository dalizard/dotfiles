...
" Last Updated: Sun Feb  6 14:53:40 2022
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
      ...
      hi SignColumn guifg=#ebdbb2 guibg=#2e2e2e gui=NONE cterm=NONE
    ...
    hi CursorLine guifg=NONE guibg=#2e2e2e gui=NONE cterm=NONE
  ...
  " Light background
  let g:terminal_ansi_colors = ['#3c3836', '#cc241d', '#98971a', '#d79921', '#458588', '#b16286', '#689d6a', '#7c6f64', '#928374', '#9d0006', '#79740e', '#b57614', '#076678', '#8f3f71', '#427b58', '#fdf6e3']
  if has('nvim')
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi Normal guifg=#3c3836 guibg=#fdf6e3 gui=NONE cterm=NONE
    hi CursorLineNr guifg=#b57614 guibg=#ebdbb2 gui=NONE cterm=NONE
    hi FoldColumn guifg=#928374 guibg=#ebdbb2 gui=NONE cterm=NONE
    hi SignColumn guifg=#3c3836 guibg=#f4ecd7 gui=NONE cterm=NONE
    hi VertSplit guifg=#bdae93 guibg=#fdf6e3 gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg=#ebdbb2 gui=NONE cterm=NONE
  hi Comment guifg=#928374 guibg=NONE gui=italic cterm=italic
  hi CursorLine guifg=NONE guibg=#f4ecd7 gui=NONE cterm=NONE
  hi Error guifg=#9d0006 guibg=#fdf6e3 gui=bold,reverse cterm=bold,reverse
  hi ErrorMsg guifg=#fdf6e3 guibg=#9d0006 gui=bold cterm=bold
  ...
  hi Visual guifg=NONE guibg=#ebdbb2 gui=NONE cterm=NONE
  hi WildMenu guifg=#076678 guibg=#d5c4a1 gui=bold cterm=bold
  hi Conceal guifg=#076678 guibg=NONE gui=NONE cterm=NONE
  hi Cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi DiffAdd guifg=#79740e guibg=#fdf6e3 gui=reverse cterm=reverse
  hi DiffChange guifg=#427b58 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi DiffDelete guifg=#9d0006 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi DiffText guifg=#b57614 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi Directory guifg=#79740e guibg=NONE gui=bold cterm=bold
  hi EndOfBuffer guifg=#fdf6e3 guibg=NONE gui=NONE cterm=NONE
  hi IncSearch guifg=#af3a03 guibg=#fdf6e3 gui=reverse cterm=reverse
  ...
  hi Search guifg=#b57614 guibg=#fdf6e3 gui=reverse cterm=reverse
  ...
  hi Todo guifg=fg guibg=#fdf6e3 gui=bold,italic cterm=bold,italic
  ...
  hi NormalMode guifg=#7c6f64 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi InsertMode guifg=#076678 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi ReplaceMode guifg=#427b58 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi VisualMode guifg=#af3a03 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi CommandMode guifg=#8f3f71 guibg=#fdf6e3 gui=reverse cterm=reverse
  hi Warnings guifg=#af3a03 guibg=#fdf6e3 gui=reverse cterm=reverse
  if has('nvim')
    hi! link TermCursor Cursor
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi BufTabLineCurrent guifg=#fdf6e3 guibg=#7c6f64 gui=NONE cterm=NONE
    ...
    hi BufTabLineFill guifg=#fdf6e3 guibg=#fdf6e3 gui=NONE cterm=NONE
    ...
    hi CtrlPMode2 guifg=#fdf6e3 guibg=#076678 gui=bold cterm=bold
    ...
    if get(g:, 'indent_guides_auto_colors', 0)
      if get(g:, 'gruvbox_invert_indent_guides', 0)
        hi IndentGuidesOdd guifg=#fdf6e3 guibg=#d5c4a1 gui=reverse cterm=reverse
        hi IndentGuidesEven guifg=#fdf6e3 guibg=#ebdbb2 gui=reverse cterm=reverse
      else
        hi IndentGuidesOdd guifg=#fdf6e3 guibg=#d5c4a1 gui=NONE cterm=NONE
        hi IndentGuidesEven guifg=#fdf6e3 guibg=#ebdbb2 gui=NONE cterm=NONE
      endif
    endif
    if !exists('g:indentLine_color_term')
    ...
    hi LanguageClientErrorSign guifg=#9d0006 guibg=#fdf6e3 gui=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_filetype_hi_groups", 0)
    ...
    hi htmlBold guifg=fg guibg=#fdf6e3 gui=bold cterm=bold
    hi htmlBoldUnderline guifg=fg guibg=#fdf6e3 gui=bold,underline cterm=bold,underline
    hi htmlBoldItalic guifg=fg guibg=#fdf6e3 gui=bold,italic cterm=bold,italic
    hi htmlBoldUnderlineItalic guifg=fg guibg=#fdf6e3 gui=bold,italic,underline cterm=bold,italic,underline
    hi htmlUnderline guifg=fg guibg=#fdf6e3 gui=underline cterm=underline
    hi htmlUnderlineItalic guifg=fg guibg=#fdf6e3 gui=italic,underline cterm=italic,underline
    hi htmlItalic guifg=fg guibg=#fdf6e3 gui=italic cterm=italic
...
" Color: bg0_s rgb(46, 46, 46) 237 DarkGray
...
" Background: light
" Color: bg0   rgb(253, 246, 227) 230 White
" Color: bg0_s rgb(244, 236, 215) 230 White
