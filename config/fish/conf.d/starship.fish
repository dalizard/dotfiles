# ABOUTME: Cached output of `starship init fish --print-full-init`.
# ABOUTME: Regenerate with: starship init fish --print-full-init > ~/.config/fish/conf.d/starship.fish
